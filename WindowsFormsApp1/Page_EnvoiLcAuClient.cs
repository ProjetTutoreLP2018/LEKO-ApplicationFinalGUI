...
{
    public partial class Page_EnvoiLcAuClient : UserControl
    {

        private ModelManager modelManager = new ModelManager();
        private List<LC> listLc;
        private string pathPDF;
        private bool envoiMail = false;

        public Page_EnvoiLcAuClient()
        {
            InitializeComponent();
        ...
        /// <summary>
        /// Méthode qui permet de valider l'envoi
        /// au client
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonEnvoyer_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView.Rows.Count; i++)
            {
                ...
                if (chkchecking.Value != null && (bool)chkchecking.Value)
                {
                    ...
                    {
                        MessageBox.Show("Une erreur est survenue, l'Email n'a pas été envoyé. Merci de vérifier votre connexion internet et que le port SMTP 587 est bien ouvert.");
                    }
        ...
        /// <summary>
        /// Méthode qui permet l'envoi par mail
        /// </summary>
        /// <param name="lc"></param>
        ...
        private void CopyLc(LC lc)
        {
         ...
         //   MessageBox.Show("Lien du ficher à copier : " + 
        ...
        /// <summary>
        /// Méthode qui permet de créer le PDF que nous enverrons au client
        /// </summary>
        /// <param name="lc"></param>
        private void CreatePDF(LC lc)
        {
           ...
           // MessageBox.Show("Le PDF a été créé : " + pathPDF);
        }
